...
int main(){
    ...
    while(t--){
        ...
        unordered_set<pair<int,int>> wordnum;
        string w;
        for(int i=0; i<n; i++){
            cin >> w;
        ...
        // unordered_set<pair<int,int>>::iterator it, it2, present_a, present_b, not_found=wordnum.end();
        // pair<int,int> a,b;
        // // Naive solution
        ...
        //             b = make_pair(it2->first, it2->second);
